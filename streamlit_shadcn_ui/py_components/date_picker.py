...
def date_picker_trigger(
    value=None, label=None, open_status=False, key=None, instance_id=None
):
    ...
    return _trigger_component(
        comp="date_picker_trigger",
        props=props,
        key=key,
...
def date_picker_content(x, y, mode, value=None, open=False, key=None, instance_id=None):
    ...
    with container:
        ...
        return _content_component(
            comp="date_picker_content",
            props=props,
            key=key,
            default={"value": None, "open": False},
        )
